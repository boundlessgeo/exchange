...
APP_ROOT = os.path.join(LOCAL_ROOT, os.path.pardir)
...
ASYNC_SIGNALS = strtobool(os.environ.get('ASYNC_SIGNALS', 'False'))
...
if CARTOVIEW_ENABLED:
    ...
    TEMPLATES[0]["OPTIONS"][
        'context_processors'] += CARTOVIEW_CONTEXT_PROCESSORS
